...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Durgesh}{Nandan}{ \urlstyle{same}\href{mailto:durgnan45@gmail.com}{durgnan45@gmail.com} | +44-7776071886 \\
\href{mailto:dxn356@student.bham.ac.uk}{dxn356@student.bham.ac.uk}
}
...
\descript{MSc in Advanced Computer Science}
\location{2024 | Birmingham, UK}
\sectionsep
...
\runsubsection{Quantiphi}\sectionsep\\
\descript{Senior Software Developer }
\location{June 2023 - Aug 2023 | Bengaluru, IN}
...
\descript{Software Engineer (MTS) }
\location{Apr 2022 - May 2023 | Bengaluru, IN}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
